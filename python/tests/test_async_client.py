...
from polaris_news.async_client import AsyncPolarisClient
from polaris_news.exceptions import AuthenticationError, RateLimitError
...
@pytest.fixture
def client():
    return AsyncPolarisClient(api_key="test-key", base_url="https://api.test.com")
